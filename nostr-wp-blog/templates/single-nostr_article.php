	...
	<main id="primary" class="site-main nostr-wp-blog nostr-wp-blog--single">
		<article <?php post_class( 'nostr-wp-blog-article' ); ?>>
			...
			if ( $show_tags ) {
				...
				if ( $topic_tags !== array() ) {
					?>
					<footer class="nostr-wp-blog-article__tags" aria-label="<?php esc_attr_e( 'Tags', 'nostr-wp-blog' ); ?>">
						<span class="nostr-wp-blog-article__tags-label"><?php esc_html_e( 'Tags', 'nostr-wp-blog' ); ?></span>
