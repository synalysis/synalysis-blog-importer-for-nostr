...
<body <?php body_class( 'nostr-wp-blog' ); ?>>
	<?php
	wp_body_open();
}
...
function nostr_wp_blog_render_card(): void {
	...
	<article <?php post_class( 'nostr-wp-blog-card' ); ?>>
		...
		<div class="nostr-wp-blog-card__body">
			...
			<?php endif; ?>
			<a class="nostr-wp-blog-card__read" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Read article', 'nostr-wp-blog' ); ?></a>
		</div>
	</article>
	<?php
}
